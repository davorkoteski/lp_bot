...
ALTER TABLE `messages`
  ...
  ADD CONSTRAINT `messages_ibfk_2` FOREIGN KEY (`plate_id`) REFERENCES `plates` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `plates`
--
ALTER TABLE `plates`
  ADD CONSTRAINT `plates_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
